...
let time__second1 = document.querySelector("#time__second1");
let time__minute1 = document.querySelector("#time__minute1");
let time__hours1 = document.querySelector("#time__hours1");
function setTime1() {
  if (time__second1.value <= 60) {
    time__second1.value--;
  }
  if (time__second1.value == 0) {
    time__second1.value = 59;
    time__minute1.value--;
  }
  if (time__minute1.value == 0) {
    time__hours1.value--;
    time__minute1.value = 59;
  }
}
